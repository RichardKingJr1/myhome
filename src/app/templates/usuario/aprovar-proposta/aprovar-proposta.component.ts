...
@Component({
  selector: 'app-aprovar-proposta',
  templateUrl: './aprovar-proposta.component.html',
  styleUrls: ['./aprovar-proposta.component.css']
})
export class AprovarPropostaComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.http.post(this.global.endereco+'buscar-aprovar-proposta.php', this.global.id_usuario)
      .subscribe(data=> {
        this.respostas = data;   
    });
  ...
  assinar(id_alugar){
    ...
    this.router.navigate(['/usuario/assinar-usuario-proprietario', id_alugar]);
  }
